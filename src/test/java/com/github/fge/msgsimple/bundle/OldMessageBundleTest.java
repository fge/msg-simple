...
public final class OldMessageBundleTest
{
    ...
    private OldMessageBundle bundle;
    ...
    public void init()
    {
        ...
        bundle = OldMessageBundle.newBundle().appendSource(source1)
    ...
    {
        try {
            OldMessageBundle.newBundle().appendSource(null);
    ...
    {
        try {
            OldMessageBundle.newBundle().prependSource(null);
            fail("No exception thrown!");
        } catch (NullPointerException e) {
    ...
    public void prependingSourceWorksAsExpected()
    {
        ...
        final OldMessageBundle bundle2 = bundle.modify().prependSource(source)
            .build();
